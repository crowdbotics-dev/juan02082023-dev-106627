...
function api_v1_vik_list(payload) {
  return juandevAPI.get(`/api/v1/vik/`)
}
function api_v1_vik_create(payload) {
  return juandevAPI.post(`/api/v1/vik/`, payload)
}
function api_v1_vik_retrieve(payload) {
  return juandevAPI.get(`/api/v1/vik/${payload.id}/`)
}
function api_v1_vik_update(payload) {
  return juandevAPI.put(`/api/v1/vik/${payload.id}/`, payload)
}
function api_v1_vik_partial_update(payload) {
  return juandevAPI.patch(`/api/v1/vik/${payload.id}/`, payload)
}
function api_v1_vik_destroy(payload) {
  return juandevAPI.delete(`/api/v1/vik/${payload.id}/`)
}

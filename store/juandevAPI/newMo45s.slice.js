...
export const api_v1_newmo45_list = createAsyncThunk(
  "newMo45s/api_v1_newmo45_list",
  async payload => {
    const response = await apiService.api_v1_newmo45_list(payload)
    return response.data
  }
)
export const api_v1_newmo45_create = createAsyncThunk(
  "newMo45s/api_v1_newmo45_create",
  async payload => {
    const response = await apiService.api_v1_newmo45_create(payload)
    return response.data
  }
)
export const api_v1_newmo45_retrieve = createAsyncThunk(
  "newMo45s/api_v1_newmo45_retrieve",
  async payload => {
    const response = await apiService.api_v1_newmo45_retrieve(payload)
    return response.data
  }
)
export const api_v1_newmo45_update = createAsyncThunk(
  "newMo45s/api_v1_newmo45_update",
  async payload => {
    const response = await apiService.api_v1_newmo45_update(payload)
    return response.data
  }
)
export const api_v1_newmo45_partial_update = createAsyncThunk(
  "newMo45s/api_v1_newmo45_partial_update",
  async payload => {
    const response = await apiService.api_v1_newmo45_partial_update(payload)
    return response.data
  }
)
export const api_v1_newmo45_destroy = createAsyncThunk(
  "newMo45s/api_v1_newmo45_destroy",
  async payload => {
...
const newMo45sSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(api_v1_newmo45_list.pending, (state, action) => {
